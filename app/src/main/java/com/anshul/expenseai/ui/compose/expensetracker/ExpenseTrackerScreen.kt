...
import com.anshul.expenseai.BuildConfig.WEB_CLIENT_ID
import com.anshul.expenseai.ui.compose.expensetracker.ExpenseTrackerViewModel.Companion.TAG
import com.anshul.expenseai.ui.compose.expensetracker.state.ExpenseTrackerSideEffect
import com.anshul.expenseai.ui.compose.expensetracker.state.ExpenseTrackerSideEffect.ShowToast
import com.anshul.expenseai.ui.nav.Screen
import com.anshul.expenseai.ui.theme.PrimaryBlue
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            if (state.recommendation?.isNotEmpty() == true) {
                item {
                    SmartInsightsCard(state.recommendation)
                }
            }
